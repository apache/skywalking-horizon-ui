...
export class TraceApi {
  ...
  detail(
     ...
     *  Without one BanyanDB searches everything the hot and warm stages
     *  keep — only the last day on OAP 11.0.0 and earlier, where an older
     *  trace ID returns null without it — and never the cold stage.
     *  The BFF converts ms → OAP-server-TZ format. */
