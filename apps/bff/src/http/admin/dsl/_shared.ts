...
/**
 * Shared deps + parsers + verb helpers for every DSL admin handler
...
export interface DslRouteDeps extends AuthDeps {
 ...
 *  OAP-error path. Used by the structural mutation routes. */
