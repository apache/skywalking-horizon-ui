...
export interface ViewStrings {
  ...
  round: string;
  segments: string;
  /** The overview cell's heading — a noun, where `segments` is the unit behind a count. */
  segmentList: string;
  streams: string;
  talks: string;
  /** The overview's talk list heading — a noun, where `talks` is the unit behind a count. */
  talkList: string;
  span: string;
  unresolved: string;
  overview: string;
  ...
  /** The transcript when the document folded nothing at all. */
